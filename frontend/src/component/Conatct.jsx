                    ...
                    <div className="row gy-3 gy-md-4 gy-lg-0 align-items-md-center ">
                        ...
                        <div className="col-12 col-lg-6">
                            <div className="bg-white border rounded shadow-sm overflow-hidden" data-aos="fade-left" style={{width:"540px", marginLeft:"100px"}}>
                                ...
                                <form classNameName='' style={{backgroundColor:" #f1f1f3" }} >
                                    <div className="row gy-4 gy-xl-5 p-4 p-xl-4 px-xl-4">
                                        <div className="col-12" >
                                            ...
                                            <input type="text" className="form-control"  required style={{padding:"10px"}} />
                                        </div>
                                        <div className="col-12 col-md-6" style={{ marginTop:"25px" }}>
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input type="email" className="form-control" required style={{padding:"10px"}}/>
                                            </div>
                                        </div>
                                        <div className="col-12 col-md-6" style={{ marginTop:"25px" }}>
                                            ...
                                            <div className="input-group">
                                                ...
                                                <input type="tel" className="form-control"  style={{padding:"10px"}} />
                                            </div>
                                        </div>
