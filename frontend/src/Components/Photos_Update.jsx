      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        {addedPhotos.length > 0 && addedPhotos.map(link => (
          ...
          <div className="h-32 flex relative" key={link}>
            <img className="rounded-2xl w-48" src={'http://localhost:8090/'+link} alt =''/>
            <button onClick={ev => removePhoto(ev,link)} className="cursor-pointer absolute bottom-1 right-1 text-white bg-black bg-opacity-0 rounded-2xl py-2 px-3 border-hidden">
